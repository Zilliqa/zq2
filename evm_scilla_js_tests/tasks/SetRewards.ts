...
import {Account, BN, Zilliqa, bytes, getAddressFromPrivateKey, Long} from "@zilliqa-js/zilliqa";
...
interface ContractContext {
  contract: ScillaContract | undefined;
...
async function checkContractDeployment(context: ContractContext) {
  const contractBalance = await context.zilliqa.blockchain.getBalance(WELL_KNOWN_CONTRACT_ADDRESS);
