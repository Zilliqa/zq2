...
contract Create2Factory {
  ...
  function deploy(uint _salt) external {
    DeployWithCreate2 _contract = new DeployWithCreate2{salt: bytes32(_salt)}(msg.sender); // the number of salt determines the address of the contract that will be deployed
