...
docker run --name scilla --add-host host.docker.internal:host-gateway --publish 3000:3000 --init --rm asia-docker.pkg.dev/prj-p-devops-services-tvwmrf63/zilliqa-public/scilla:a5a81f72 /scilla/0/bin/scilla-server-http
