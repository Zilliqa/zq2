...
cargo build -p zilliqa --bin zilliqa --release
RUST_LOG=zilliqa=warn,jsonrpsee=trace ./target/release/zilliqa 65d7f4da9bedc8fb79cbf6722342960bbdfb9759bc0d9e3fb4989e831ccbc227 -c bundler_tests/config-bundler-spec-tests.toml > /tmp/zil_log_bundler.txt 2>&1 &
