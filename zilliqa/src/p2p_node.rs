                ...
                event = self.swarm.next() => {
                    ...
                    match event {
                        ...
                        SwarmEvent::Behaviour(BehaviourEvent::Gossipsub(gossipsub::Event::Message{
                            ...
                            let to = self.peer_id;
                            debug!(%source, %to, %message, %topic_hash, "broadcast recieved");
                            ...
                            match message {
                                ...
                                // NewView messages are temporarily published to all topics. Ignore those not from validator topic after upgrade
                                ExternalMessage::NewView(_) => {
                                    // if Self::is_validator_topic_hash(&topic_hash) {
