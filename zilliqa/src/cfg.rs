...
pub struct NodeConfig {
    ...
    #[serde(default)]
    pub adjust_state: Option<StateAdjustment>,
...
pub struct StateAdjustment {
    /// Reset the deposit contract and accounts on load; this allows you to load a checkpoint not generated by these validators.
    #[serde(default)]
