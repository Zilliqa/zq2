...
impl BlockHooks {
    ...
    pub fn get_launch_shard_messages(&self, receipts: Vec<TransactionReceipt>) -> Result<Vec<u64>> {
        let shard_logs = self.filter_receipts(
            receipts,
    ...
    pub fn get_cross_shard_messages(
        ...
        let bridge_logs = self.filter_receipts(
            receipts,
