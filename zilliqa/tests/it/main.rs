...
use zilliqa::{
    cfg::{
        ...
        ConsensusConfig, NodeConfig, ScillaExtLibsCacheFolder,
    },
    ...
    pub fn new_shard(
        ...
        let config = NodeConfig {
            ...
            consensus: ConsensusConfig {
                ...
                scilla_ext_libs_cache_folder: ScillaExtLibsCacheFolder {
                    on_host: "scilla_ext_libs".to_string(),
                    on_docker: "/scilla_ext_libs".to_string(),
                },
