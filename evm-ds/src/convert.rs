...
//impl From<&ExitSucceed> for EvmProto::ExitReason {
//    fn from(exit_reason: &ExitSucceed) -> Self {
//        match exit_reason {
//            ExitSucceed::Stopped =>  ExitReasonCps::Succeed(Succeed::Stopped),
//            ExitSucceed::Returned => ExitReasonCps::Succeed(Succeed::Returned),
//            ExitSucceed::Suicided => ExitReasonCps::Succeed(Succeed::Suicided),
//        }
//    }
//}
...
////        match arg {
////            evm::ExitSucceed::Stopped => EvmProto::E,
