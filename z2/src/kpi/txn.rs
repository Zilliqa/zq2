...
use super::{
    ...
    CallTransactionResult, KpiResult, ScenarioAgent,
};
        ...
        match self.r#type {
            config::CallTransactionsType::ZilTransfer => {
                ...
                for _ in 0..num_transactions {
                    ...
                    let future: tokio::task::JoinHandle<
                        Result<(f64, bool, u64), zilliqa_rs::Error>,
                ...
                let success_rate =
                    results.iter().filter(|r| r.1).count() as f32 / self.iterations as f32;
            ...
            config::CallTransactionsType::EthTransfer => todo!(),
