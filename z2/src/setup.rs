...
use zilliqa::{
    ...
    cfg::{
        ...
        scilla_ext_libs_cache_folder_default, scilla_lib_dirs_default,
        scilla_lib_extension_default, state_rpc_limit_default, Amount, ConsensusConfig,
    },
...
impl Setup {
    ...
    pub async fn generate_config(&self) -> Result<()> {
        ...
        for i in 0..self.how_many {
            ...
            node_config.consensus.scilla_lib_dirs =
                scilla::Runner::get_scilla_lib_dirs(&self.base_dir);
